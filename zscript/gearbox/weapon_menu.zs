...
class gb_WeaponMenu
{
  ...
  ui bool setSelectedIndexFromView(gb_ViewModel viewModel, int index)
  {
  ...
  ui bool selectSlot(int slot, bool selectFirstWeapon = false)
  {
  ...
  ui bool isOneWeaponInSlot(int slot) const
  {
    uint nWeapons = mWeapons.size();
  ...
  ui bool isInInventory(int index) const
  {
  ...
  ui bool isThereNoWeapons() const
  {
...
// private: ////////////////////////////////////////////////////////////////////////////////////////
  ...
  private ui bool isHidden(string className) const
  {
    bool result = false;
