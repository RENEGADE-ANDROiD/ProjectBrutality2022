...
class gb_EventHandler : EventHandler
{
  ...
  private ui bool pbWeaponWheelAllowed()
  {
    PlayerInfo plr = players[consoleplayer];
    if (!plr) return true;
    let cv = CVar.GetCVar("pb_weapon_wheel_enable", plr);
  ...
  bool inputProcess(InputEvent event)
  {
    ...
    else if (mActivity.isNone())
    {
      ...
      if (pbWeaponWheelAllowed() && gb_Input.isSlot(input) && mOptions.isOpenOnSlot())
      {
        int slot = gb_Input.getSlot(input);
      ...
      if (!pbWeaponWheelAllowed()) return false;
  ...
  ui bool GetGearboxWantsPPBlur() const { return mGearboxWantsPPBlur; }
  ...
  void renderOverlay(RenderEvent event)
  {
    ...
    mGearboxWantsPPBlur = mOptions.isBlurEnabled() && !mActivity.isNone();
...
// private: ////////////////////////////////////////////////////////////////////////////////////////
  ...
  void toggleWeapons()
  {
    if (!pbWeaponWheelAllowed()) return;
  ...
  private ui bool mGearboxWantsPPBlur;
