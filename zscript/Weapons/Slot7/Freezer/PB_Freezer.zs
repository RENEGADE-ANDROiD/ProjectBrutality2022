// PB_Freezer - ZScript port (DECORATE PB_Weapon retired).

class PB_Freezer : PB_WeaponBase
{
	default
	{
	...
	PB_WeaponBase.UnloaderToken "HasUnloadedFreezer";
	}
	states
	{
		...
		SwitchToBeam:
			TNT1 A 0 {
				if (CountInv("FreezerPistolToken") >= 1) {
					...
					return ResolveState("UnequipPistol");
				}
			...
			TNT1 A 0 {
				...
				A_Print("\ctFire mode:\c- \chFreeze ray \c-");
		...
		SwitchToMissile:
			TNT1 A 0 {
				...
				A_Print("\ctFire mode:\c- \ciIce missile \c-");
				A_PlaySoundEx("weapons/freezer/up", "Auto");
				A_PlaySoundEx("weapons/freezer/reload1", "Auto");
			}
			"FR22" "ABCDEFGHIJ" 1;
		...
		PDA_Preview_FreezerReady:
			"FR03" E 1 A_WeaponReady(WRF_NOFIRE);
			"FR03" F 1 A_WeaponReady(WRF_NOFIRE);
			"FR03" G 1 A_WeaponReady(WRF_NOFIRE);
			Stop;
		PDA_Preview_FreezerMissile:
			"FR10" A 1 BRIGHT A_WeaponReady(WRF_NOFIRE);
			"FR10" B 1 BRIGHT A_WeaponReady(WRF_NOFIRE);
			"FR10" C 1 BRIGHT A_WeaponReady(WRF_NOFIRE);
			Stop;
		PDA_Preview_FreezerBeamCharge:
			"FR11" I 1 A_WeaponReady(WRF_NOFIRE);
			"FR11" H 1 A_WeaponReady(WRF_NOFIRE);
			"FR11" G 1 A_WeaponReady(WRF_NOFIRE);
			Stop;
		PDA_Preview_FreezerBeamLoop:
			"FR13" A 1 BRIGHT A_WeaponReady(WRF_NOFIRE);
			"FR13" B 1 BRIGHT A_WeaponReady(WRF_NOFIRE);
			"FR13" C 1 BRIGHT A_WeaponReady(WRF_NOFIRE);
			"FR13" B 1 BRIGHT A_WeaponReady(WRF_NOFIRE);
			Stop;
		PDA_Preview_FreezerBeamEnd:
			"FR10" D 1 A_WeaponReady(WRF_NOFIRE);
			"FR10" E 1 A_WeaponReady(WRF_NOFIRE);
			"FR10" F 1 A_WeaponReady(WRF_NOFIRE);
			Stop;
