// PB_LMG - ZScript port (DECORATE PB_Weapon retired).
...
Weapon.SlotPriority 0.5;
	...
	states
	{
		...
		"LMPI" A 0 NoDelay ACS_NamedExecuteAlways("ToggleLMG",0);
		SpawnLoop:
		"LMPI" A 10 BRIGHT;
		Loop;
		// Spawn voxel model path not implemented (was DECORATE comment block).
		PDA_Preview_LMG_Fire:
		"LMGF" A 2 Bright;
		"LMGF" B 2 Bright;
		"LMGF" C 2;
		"LMGF" D 2;
		Stop;
		PDA_Preview_LMG_Missile:
		"LMMF" A 2 Bright;
		"LMMF" B 2 Bright;
		"LMMF" C 2;
		"LMMF" D 2;
		Stop;
		PDA_Preview_LMG_Reload:
		"LMR1" "ABCDEFGHIJ" 2;
		"LRMR" "ABCDE" 2;
		"LMR4" "CDEFGH" 2;
		Stop;
		...
		TNT1 A 0 A_StartSound("weapons/sgl/inspect1", 4);
		...
		LSM3 E 1 {
				...
				if (PressingFire() && PressingAltfire() && CountInv("LMGAmmo") > 3){
					return ResolveState("FireMissile");
				}
	...
	//Zoom
        ...
        "LBA4" A 0;
        "####" Q 1 {
            return PB_ReadyFire("Fire", "Fire2", "Unzoom", true, false, "LMGAmmo", true, "PBLMGHasUnloaded", WRF_NOFIRE, true);
        }
        Loop;
		Ready2Micro:
        ...
        "####" Q 1 {
            ...
            if(GetCvar("pb_toggle_aim_hold")) {
                ...
                if (PressingFire() && PressingAltfire() && CountInv("LMGAmmo") > 0){
                        return ResolveState("Fire2Missile");
                }
		...
		TNT1 A 0 A_FireBullets (0.1, 0.1, -1, 30, "MachineGunBulletPuff", FBF_NORANDOM,8192,"Tracer", -2,0);
		TNT1 A 0 A_PB_LMGFireFX(1);
	...
	//QUITE A unload code
		...
		"####" A 0;
		"####" "PONM" 1;
		"####" A 0 A_StartSound("weapons/sgl/inspect1", 2);
		"####" "LLLLKJIHHHH" 1;
		"####" "HGF" 1;
		"####" A 0 {
			If (CountInv("LMGMicroMissiles") == 1) {
...
// 		"####" A 0 A_JumpIfInventory("LMGAmmo", 3, 2)
		...
		"####" "OP" 1;
		"####" A 0 A_StartSound("weapons/sgl/inspect1", 4);
		"####" "QRSTUVWXYZ" 1;
		...
		TNT1 A 0 A_GiveInventory("LMGMicroMissiles", 1);
		...
		"####" A 0;
		"####" "ABC" 1;
		"LBS1" "HIJKLMNOPQRSTUVWXYZ" 1;
		"LBS2" "ABCDEF" 1;
		TNT1 A 0 A_StartSound("MG42RE");
		"LBS2" "GHIJKLMNOPQRSTUVWXYZ" 1;
		"LBS3" "ABCDEFGHIJKLMNOPQR" 1;
		...
		MissileToBullet:
		TNT1 A 0 A_TakeInventory("LMGMicroMissiles", 1);
		...
		"####" A 0;
		"####" "ABC" 1;
		"LMS1" "HIJKLMNOPQRSTUVWXYZ" 1;
		"LMS2" "ABCDEF" 1;
		TNT1 A 0 A_StartSound("MG42RE");
		"LMS2" "GHIJKLMNOPQRSTUVWXYZ" 1;
		"LMS3" "ABCDEFGHIJKLMNOPQR" 1;
		TNT1 A 0 A_StartSound("MG42IN");
		"LMS3" "STVWX" 1;
		"LMS4" "ABCDEFGHIJKLMNOPQRST" 1;
		"LMS1" A 0 A_JumpIfInventory("LMGAmmo", 18, 5);
		"LM86" A 0 A_JumpIfInventory("LMGAmmo", 15, 4);
		"LM85" A 0 A_JumpIfInventory("LMGAmmo", 12, 3);
		"LM84" A 0;
