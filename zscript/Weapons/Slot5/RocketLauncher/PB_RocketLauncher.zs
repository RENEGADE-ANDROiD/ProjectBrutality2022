// PB_RocketLauncher - ZScript port (DECORATE PB_Weapon retired).

class PB_RocketLauncher : PB_WeaponBase
{
	default
	{
	...
	+WEAPON.EXPLOSIVE;
    +WEAPON.NOALERT;
	Inventory.PickupMessage "You got the UAC Guided Rocket Launcher! (Slot 6)";
	Tag "Rocket Launcher";
	...
	states
	{
		...
		SelectAnimation:
			TNT1 A 0 A_PlaySoundEx("weapons/sgl/inspect2", "Auto");
		...
		CantFire:
			TNT1 A 0 A_PlaySoundEx("weapons/rocket/seeker_nofire", "Auto");
			"RL09" EE 1;
			"RL98" EE 1;
			"RL09" EE 1;
			"RL98" EE 1;
		...
		Firing_Single:
			...
			TNT1 A 0 A_JumpIfInventory("RocketRounds",1,"Firing_Normal");
		Firing_Empty:
			RL06 FEDC 1 {
				if (PB_GetCurrentRocketMode() == "Laser") {
					A_SetWeaponSprite("RL58");
		...
		LockOn_Scan1:
			...
			RL09 E 1 {
				...
				if(CountInv("RocketLauncher_LockOnTargets")>1) {
					return ResolveState("LockOn_LoadRocket_Double");
				}
				return ResolveState(null);
			}
		...
		LockOn_Scan2:
			...
			RL35 X 1 {
				...
				if(CountInv("RocketLauncher_LockOnTargets")>2) {
					return ResolveState("LockOn_LoadRocket_Triple");
				}
				return ResolveState(null);
			}
			...
			RL88 H 1 BRIGHT {
				...
				if(GetCvar("pb_toggle_aim_hold")) {
					...
					if (PB_GetCurrentRocketMode() != "Homing" && PressingFire() && PressingAltfire() && CountInv("RocketRounds") > 0 && CountInv("RL_CoolDown") == 0){
							return ResolveState("Scope_Fire");
					}
		...
		ZoomIn:
			...
			TNT1 A 0 {
				...
				A_Overlay(65, "Scope_AmmoOverlay5");
				A_Overlay(64, "Scope_AmmoOverlay4");
				A_Overlay(63, "Scope_AmmoOverlay3");
				A_Overlay(62, "Scope_AmmoOverlay2");
				A_Overlay(61, "Scope_AmmoOverlay1");
			}
			Goto Ready2;
		ZoomOut:
			TNT1 A 0 {
		...
		Scope_AmmoOverlay6:
			...
			"R104" A 0;
			R102 A 1 BRIGHT {
				if(CountInv("RocketRounds") >= 6  && PB_GetCurrentRocketMode() == "Standard") {
					A_SetOverlaySprite(66, "R101");
				}
				if(CountInv("RocketRounds") >= 6  && PB_GetCurrentRocketMode() == "Homing") {
					A_SetOverlaySprite(66, "R103");
				}
				if(CountInv("RocketRounds") >= 6  && PB_GetCurrentRocketMode() == "Laser") {
					A_SetOverlaySprite(66, "R104");
				}
			}
		...
		Scope_AmmoOverlay5:
			...
			"R104" B 0;
			R102 B 1 BRIGHT {
				if(CountInv("RocketRounds") >= 5  && PB_GetCurrentRocketMode() == "Standard") {
					A_SetOverlaySprite(65, "R101");
				}
				if(CountInv("RocketRounds") >= 5  && PB_GetCurrentRocketMode() == "Homing") {
					A_SetOverlaySprite(65, "R103");
				}
				if(CountInv("RocketRounds") >= 5  && PB_GetCurrentRocketMode() == "Laser") {
					A_SetOverlaySprite(65, "R104");
				}
			}
			TNT1 A 0 A_JumpIf(CountInv("Zoomed") == 0, 1);
			Loop;
		...
		Scope_AmmoOverlay4:
			...
			"R104" C 0;
			R102 C 1 BRIGHT {
				if(CountInv("RocketRounds") >= 4  && PB_GetCurrentRocketMode() == "Standard") {
					A_SetOverlaySprite(64, "R101");
				}
				if(CountInv("RocketRounds") >= 4  && PB_GetCurrentRocketMode() == "Homing") {
					A_SetOverlaySprite(64, "R103");
				}
				if(CountInv("RocketRounds") >= 4  && PB_GetCurrentRocketMode() == "Laser") {
					A_SetOverlaySprite(64, "R104");
				}
			}
			TNT1 A 0 A_JumpIf(CountInv("Zoomed") == 0, 1);
			Loop;
		...
		Scope_AmmoOverlay3:
			...
			"R104" D 0;
			R102 D 1 BRIGHT {
				if(CountInv("RocketRounds") >= 3  && PB_GetCurrentRocketMode() == "Standard") {
					A_SetOverlaySprite(63, "R101");
				}
				if(CountInv("RocketRounds") >= 3  && PB_GetCurrentRocketMode() == "Homing") {
					A_SetOverlaySprite(63, "R103");
				}
				if(CountInv("RocketRounds") >= 3  && PB_GetCurrentRocketMode() == "Laser") {
					A_SetOverlaySprite(63, "R104");
				}
			}
			TNT1 A 0 A_JumpIf(CountInv("Zoomed") == 0, 1);
			Loop;
		...
		Scope_AmmoOverlay2:
			...
			"R104" E 0;
			R102 E 1 BRIGHT {
				if(CountInv("RocketRounds") >= 2  && PB_GetCurrentRocketMode() == "Standard") {
					A_SetOverlaySprite(62, "R101");
				}
				if(CountInv("RocketRounds") >= 2  && PB_GetCurrentRocketMode() == "Homing") {
					A_SetOverlaySprite(62, "R103");
				}
				if(CountInv("RocketRounds") >= 2  && PB_GetCurrentRocketMode() == "Laser") {
					A_SetOverlaySprite(62, "R104");
				}
			}
			TNT1 A 0 A_JumpIf(CountInv("Zoomed") == 0, 1);
			Loop;
		...
		Scope_AmmoOverlay1:
			...
			"R104" F 0;
			R102 F 1 BRIGHT {
				if(CountInv("RocketRounds") >= 1  && PB_GetCurrentRocketMode() == "Standard") {
					A_SetOverlaySprite(61, "R101");
				}
				if(CountInv("RocketRounds") >= 1  && PB_GetCurrentRocketMode() == "Homing") {
					A_SetOverlaySprite(61, "R103");
				}
				if(CountInv("RocketRounds") >= 1  && PB_GetCurrentRocketMode() == "Laser") {
					A_SetOverlaySprite(61, "R104");
				}
			}
			TNT1 A 0 A_JumpIf(CountInv("Zoomed") == 0, 1);
			Loop;
		...
		RL29 Z 1 BRIGHT {
			...
			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL35");}
		}
		RL30 ABCD 1 {
			if (PB_GetCurrentRocketMode() == "Laser") {
				A_SetWeaponSprite("RL43");
				A_SpawnLaserPuff(0,0,"GuidedLaser");
			}
			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL36");}
		}
        TNT1 A 0 A_JumpIfInventory("RocketRounds",1,"FireRocket_Double_Normal");
		FireRocket_Double_Empty:
		RL30 DBCA 1 {
			if (PB_GetCurrentRocketMode() == "Laser") {
				A_SetWeaponSprite("RL43");
				A_SpawnLaserPuff(0,0,"GuidedLaser");
		...
		RL32 ABCD 1 {
			if (PB_GetCurrentRocketMode() == "Laser") {
				A_SetWeaponSprite("RL47");
				A_SpawnLaserPuff(0,0,"GuidedLaser");
			}
			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL39");}
		}
        TNT1 A 0 A_JumpIfInventory("RocketRounds",1,"FireRocket_Triple_Normal");
		FireRocket_Triple_Empty:
		RL32 DCBA 1 {
			if (PB_GetCurrentRocketMode() == "Laser") {
				A_SetWeaponSprite("RL47");
				A_SpawnLaserPuff(0,0,"GuidedLaser");
		...
		RL19 ABCDEF 1 {
			A_SetRoll(roll-0.5,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL62");}
		...
		RL19 GH 1 {
			A_SetRoll(roll+0.1,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL62");}
			if (PB_GetCurrentRocketMode() == "Laser") {A_SetWeaponSprite("RL69");}
		}
		...
		RL19 LMNO 1 {
			A_SetRoll(roll+1,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL62");}
			if (PB_GetCurrentRocketMode() == "Laser") {A_SetWeaponSprite("RL69");}
		}
		...
		RL20 ABCDE 1 {
			A_SetRoll(roll-0.4,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL63");}
			if (PB_GetCurrentRocketMode() == "Laser") {A_SetWeaponSprite("RL70");}
		}
		
		RL20 FG 1 {
			A_SetRoll(roll+0.5,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL63");}
			if (PB_GetCurrentRocketMode() == "Laser") {A_SetWeaponSprite("RL70");}
		}
		RL20 HIJKL 1 {
			A_SetRoll(roll-0.3,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL63");}
			if (PB_GetCurrentRocketMode() == "Laser") {A_SetWeaponSprite("RL70");}
		}
		
		RL20 MNOPQR 1 {
			A_SetRoll(roll+0.2,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL63");}
			if (PB_GetCurrentRocketMode() == "Laser") {A_SetWeaponSprite("RL70");}
		}
		TNT1 A 0 A_StartSound("weapons/sgl/slap", CHAN_AUTO, CHANF_OVERLAP);
		RL20 ST 1 {
			A_SetRoll(roll-0.8,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL63");}
			if (PB_GetCurrentRocketMode() == "Laser") {A_SetWeaponSprite("RL70");}
		}
		RL20 UVWXYZ 1 {
			A_SetRoll(roll-0.1,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL63");}
			if (PB_GetCurrentRocketMode() == "Laser") {A_SetWeaponSprite("RL70");}
		}
		TNT1 A 0 A_StartSound("weapons/rocket/handling", CHAN_AUTO, CHANF_OVERLAP);
		...
		TNT1 A 0 A_StartSound("weapons/rocket/innercycle", CHAN_AUTO, CHANF_OVERLAP);
		RL22 ABCDEF 1 {
			A_SetRoll(roll+0.2,SPF_INTERPOLATE); 			if (PB_GetCurrentRocketMode() == "Homing") {A_SetWeaponSprite("RL65");}
