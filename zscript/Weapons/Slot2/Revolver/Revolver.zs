Class PB_Revolver : PB_WeaponBase
{
	...
	states
	{
		...
		Reload:
			...
			TNT1 A 0 PB_CheckReload(null, null, null, "Ready3", "Ready3", 6, 2);
		...
		ContinueReload:
			...
			TNT1 A 0 {
				...
				PB_AmmoIntoMag("RevolverAmmo","PistolBullets",6,2);
		...
		ReloadDualWield:
			...
			TNT1 A 0 PB_CheckReload(null, null, null, "ReloadLeftOnly", "Ready3", 6, 2);
		...
		ContinueReloadRight:
			...
			Goto ReloadLeft;
		ReloadLeftOnly:
			TNT1 A 0 PB_CheckReload(null, null, null, "Ready3", "Ready3", 6, 2, true);
			40V1 EFGHI 1;
		ReloadLeft:
		...
		ContinueReloadLeft:
			...
			TNT1 A 0 {
				A_StartSound("Weapons/Revolver/Load",10,CHANF_OVERLAP);
				PB_AmmoIntoMag("LeftRevolverAmmo","PistolBullets",6,2);
				PB_SpawnCasing("RevolverSpeedLoader", 45.6, 9, 18.75,frandom(-1,1),frandom(-1.2, -0.6), frandom(1,-1));
		...
		Unload:
			...
			TNT1 A 0 {
				A_StartSound("Weapons/Revolver/Click2", 10,CHANF_OVERLAP);
				PB_RevolverCasingSpawn("RevolverAmmo");
				PB_UnloadMag("RevolverAmmo","PistolBullets",2,1,2,0,"PB_MagnumRound");
				PB_SetChamberEmpty(true);
				PB_SetMagUnloaded(true);
				PB_SetMagEmpty(true);
			}
		...
		UnloadLeft:
			...
			TNT1 A 0 {
				A_StartSound("Weapons/Revolver/Click2", 10,CHANF_OVERLAP);
				PB_RevolverCasingSpawn("LeftRevolverAmmo");
				PB_UnloadMag("LeftRevolverAmmo","PistolBullets",2,1,2,0,"PB_MagnumRound");
				PB_SetChamberEmpty(true,true);
				PB_SetMagUnloaded(true,true);
...
class PB_MagnumRound : Inventory
{
	default
	{
		+NOBLOCKMAP;
