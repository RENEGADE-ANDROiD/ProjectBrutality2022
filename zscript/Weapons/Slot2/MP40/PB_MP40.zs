// PB_MP40 - ZScript port (DECORATE PB_Weapon retired).
...
class PB_MP40 : PB_WeaponBase
{
	...
	states
	{
		...
		ReadyToFire:
			MPSE E 1 {
				return PB_ReadyFire("Fire", "Fire", "Zoomout", false, false, "MP40Ammo", true, "MP40HasUnloaded");
			}
			Loop;
		...
		ReadyToFire2:
			"MPZO" E 1 {
				return PB_ReadyFire("Fire2", "Fire2", "Zoomout", true, false, "MP40Ammo", true, "MP40HasUnloaded");
			}
			Loop;
		...
		IdleLeft_Overlay:
			MP21 A 1 {
				...
				if(CountInv("DualFiring")==0 || (CountInv("DualFiring")==0 && CountInv("MP40Ammo")<=0) || GetCvar("SingleDualFire")==1){
		...
		FireLeft_Overlay:
			"MP21" B 1 BRIGHT {
				...
				A_AlertMonsters();
				A_PlaySoundEx("weapons/mp40_fire", "SoundSlot5");
				A_FireBullets (0.1, 0.1, -1, 17, "HitPuff", FBF_NORANDOM,8192,"Tracer", -4, -8);
		...
		WeaponSpecial:
			...
			TNT1 A 0 A_Print("\ckNeed two \ctMP40s \c-to dual-wield");
			Goto Ready3;
		SwitchToDualWield:
			TNT1 A 0 {
		...
		ReloadRightEmptyInsert:
			...
			"MRCO" "ABCDE" 1;
			TNT1 AAAA 1;
			TNT1 A 0 A_JumpIf(CountInv("LeftMP40Ammo") < 32 && CountInv("NewClip") > 0, "ReloadLeftGunAfterEmpty");
		...
		ReloadRight:
			...
			"MPR2" "TU" 1 A_SetRoll(roll-1.5, SPF_INTERPOLATE);
 			"MPR2" "VWXYZ" 1;
  			"MPR3" A 1;
			TNT1 A 0 A_JumpIf(CountInv("LeftMP40Ammo") < 32 && CountInv("NewClip") > 0, "ReloadLeftGun");
			"M2R1" A 0;
			"####" A 0;
			"M2R1" "DCBA" 1;
			TNT1 A 0 A_JumpIfInventory("MP40WasEmpty",1,"InsertBullets3");
		...
		UnloadDual:
			...
			TNT1 A 0 {
					if (CountInv("MP40Ammo") >= 1) {
							...
							A_Giveinventory("PB_LockScreenTilt",1);
							A_ClearOverlays(10,11);
							return ResolveState("UnloadRight");
						}
...
//////////////////////////////////////////Unloading
		...
		PDA_Preview_MP40_Fire:
			"MPFI" A 1 BRIGHT;
			"MPFI" B 1;
			"MPFI" C 1;
			Stop;
		PDA_Preview_MP40_AdsFire:
			"MPZO" F 1 BRIGHT;
			"MPZO" G 1;
			"MPZO" H 1;
			Stop;
		PDA_Preview_MP40_AltAds:
			"MPZO" A 1;
			"MPZO" B 1;
			"MPZO" C 1;
			"MPZO" D 1;
			Stop;
		PDA_Preview_MP40_Reload:
			"MPR1" A 1;
			"MPR1" D 1;
			"MPR1" M 1;
			"MPR2" F 1;
