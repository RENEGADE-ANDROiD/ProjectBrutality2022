// HASG - ZScript port (DECORATE PB_Weapon retired).

class HASG : PB_WeaponBase
{
	default
	{
    Weapon.SlotNumber 3;
	...
	states
	{
        ...
        TNT1 A 0 {
            if (CountInv("ASGDrum") >= 1) {
                ...
                return ResolveState("HASGDrumRespect");
            }
        ...
        TNT1 A 0 A_PlaySound("ironsight1");
        "LGZU" AB 1;
        ...
        TNT1 A 0 A_PlaySound("ironsight2");
        "LGZU" C 1;
        TNT1 A 0 A_SetPitch(-1.0 + pitch);
        "LGZU" BA 1;
        TNT1 A 0 A_SetPitch(-1.0 + pitch);
        ...
        GLXF A 1 BRIGHT {
            ...
            if (Countinv("HASG_DRBT") >= 1) {
                A_StartSound("weapons/golide/fire_db", CHAN_Weapon);
                ...
                return ResolveState("ContFire");
            }
            if (Countinv("HASG_Flech") >= 1) {
                A_StartSound("weapons/golide/fire_flech", CHAN_Weapon);
            ...
            if (Countinv("HASG_Slug") >= 1) {
                A_StartSound("weapons/golide/fire_slug", CHAN_Weapon);
            ...
            A_StartSound("weapons/golide/fire", CHAN_Weapon);
            A_PlaySound("ASG/Add", CHAN_Weapon, 0.88, 0, 2);
        ...
        TNT1 A 0 PB_WeaponRecoil(-0.30, -0.35);
        ...
        GL2F A 1 BRIGHT {
            ...
            if (Countinv("HASG_WPhos") >= 1) {
                A_StartSound("weapons/golide/fire_wp", CHAN_Weapon);
                ...
                return ResolveState("ContDrumFire");
            }
            if (Countinv("HASG_Danmaku") >= 1) {
                A_PlaySound("CSSGDANS", CHAN_Weapon, 0.99, 0, 2);
                A_PlaySound("SHOTGUN", CHAN_Weapon, 0.88, 0, 2);
            ...
            if (Countinv("HASG_Explosive") >= 1) {
                A_StartSound("weapons/golide/fire_expl", CHAN_Weapon);
        ...
        "G11R" D 1;
        TNT1 A 0 A_GiveInventory("ASGChamber", 1);
        TNT1 A 0 A_PlaySound("ASG/RL", 2);
        "G11R" EF 1 PB_ReFire("ReloadEnd");
        "G11R" G 1;
        TNT1 A 0 PB_ReFire("ReloadEnd");
        TNT1 A 0 PB_ReFire("ReloadEnd");
        "G11R" H 1;
        ...
        TNT1 A 0 A_ZoomFactor(1.0);
        TNT1 A 0 A_TakeInventory("Reloading", 1);
        TNT1 A 0 A_PlaySound("RANEQ", 6);
        TNT1 A 0 A_PlaySound("BDLOAD", 2);
        "GL1R" AB 1;
        "GL1R" CD 2;
        "GL1R" EF 1;
        TNT1 A 0 A_JumpIfInventory("Unloaded_Golide", 1, "LoadMag");
        "DRMR" X 3;
        ...
        TNT1 A 0 {
            if (CountInv("HASG_SelectBuck") == 1)      { A_Overlay(-12, "WheelCancel"); return ResolveState("SwitchToBuckShot"); }
            if (CountInv("HASG_SelectSlug") == 1)      { A_Overlay(-12, "WheelCancel"); return ResolveState("SwitchToSlug"); }
            if (CountInv("HASG_SelectFlech") == 1)     { A_Overlay(-12, "WheelCancel"); return ResolveState("SwitchToFlechette"); }
            if (CountInv("HASG_SelectDRBT") == 1)      { A_Overlay(-12, "WheelCancel"); return ResolveState("SwitchToBreath"); }
            if (CountInv("HASG_SelectExplosive") == 1) { A_Overlay(-12, "WheelCancel"); return ResolveState("SwitchToExplosive"); }
            if (CountInv("HASG_SelectDanmaku") == 1)   { A_Overlay(-12, "WheelCancel"); return ResolveState("SwitchToDanmaku"); }
        ...
        TNT1 A 0 A_SetInventory("HASG_Danmaku", 0);
        TNT1 A 0 A_SetInventory("HASG_WPhos", 0);
        TNT1 A 0 A_Print("Flechette Loaded");
        Goto LoadWithoutMag;
		...
		SwitchToExplosive:
        TNT1 A 0 A_TakeInventory("GoWeaponSpecialAbility", 1);
        TNT1 A 0 A_JumpIfInventory("HASG_Explosive", 1, "AlreadyLoaded");
        TNT1 A 0 A_SetInventory("HASG_Buck", 0);
        TNT1 A 0 A_SetInventory("HASG_Slug", 0);
        TNT1 A 0 A_SetInventory("HASG_Flech", 0);
        TNT1 A 0 A_SetInventory("HASG_DRBT", 0);
        TNT1 A 0 A_SetInventory("HASG_Explosive", 1);
        TNT1 A 0 A_SetInventory("HASG_Danmaku", 0);
        TNT1 A 0 A_SetInventory("HASG_WPhos", 0);
        TNT1 A 0 A_Print("Explosive Loaded");
        Goto LoadWithoutMag;
