...
class PB_QuadSG : PB_WeaponBase
{
	default
	{
		//Title Quadruple Barreled Shotgun
		//Category Weapons
		//Sprite QSPGA0
	// SpawnID (DECORATE editor only) 9360
	...
	SelectContinue:
		...
		TNT1 A 0 PB_WeapTokenSwitch("QSGSelected");
        ...
        TNT1 A 0 {
			...
			if (CountInv("FullBlastMode") == 1) {
					...
					if (CountInv("BreathMode") != 1) {
						...
						PB_FireBullets("PB_8GAPellet_LP", 4, 0, 0, 0, 0);
						PB_FireBullets("PB_8GAPellet", 48, 7, 0, 0, 5);
						A_PB_ThrottledMuzzleFXDual(-2, 2, 0, 0, "", 'QuadSGFXPhase');
					}
					else {
						A_FireCustomMissile("YellowFlareSpawn", 15, 0, 0, 0);
						...
						return ResolveState("LeftRecoil_FullBlast");
				}
			}
			else if (CountInv("LeftQSSGAmmoCounter") >= 2)  {
						A_Recoil(3);
						A_PlaySound("SSHFIRE", 1);
						A_ZoomFactor(0.915);
					...
					if (CountInv("BreathMode") != 1) {
						...
						A_FireProjectile("ShotgunWad",random(-1,1),0,-10,-2,FPF_NOAUTOAIM,random(-1,1));
						A_FireCustomMissile("YellowFlareSpawn", 15, 0, 0, 0);
						PB_FireBullets("PB_8GAPellet_LP", 2, 0, 0, 0, 0);
						PB_FireBullets("PB_8GAPellet", 24, 7, 0, 0, 5);
						A_PB_ThrottledMuzzleFX(-2, 0, 0, "", 'QuadSGFXPhase');
					}
					else {
						A_FireCustomMissile("YellowFlareSpawn", 15, 0, 0, 0);
						...
						return ResolveState("LeftRecoil_HalfBlast");
			}
				else {
						A_Recoil(3);
						A_PlaySound("weapons/shh2", 1);
						A_ZoomFactor(0.915);
						A_TakeInventory("LeftQSSGAmmoCounter", 1);
					if (CountInv("BreathMode") != 1) {
						A_FireProjectile("ShotgunWad",random(-1,1),0,-6,-2,FPF_NOAUTOAIM,random(-1,1));
						A_FireCustomMissile("YellowFlareSpawn", 15, 0, 0, 0);
						PB_FireBullets("PB_8GAPellet", 12, 7, 0, 0, 5);
						A_PB_ThrottledMuzzleFX(-2, 0, 0, "", 'QuadSGFXPhase');
					}
					else {
						A_FireCustomMissile("YellowFlareSpawn", 15, 0, 0, 0);
        ...
        TNT1 A 0 {
			if (CountInv("FullBlastMode") == 1) {
					...
					if (CountInv("BreathMode") != 1) {
						...
						return ResolveState("RightRecoil_FullBlast");
				}
			}
					...
					if (CountInv("BreathMode") != 1) {
						...
						return ResolveState("RightRecoil_HalfBlast");
			}
				else {
						A_Recoil(3);
						A_PlaySound("weapons/shh2", 1);
	...
	DualWield:
		...
		TNT1 A 0 A_Print("\ckNeed two \ctquad shotguns \c-to dual-wield");
		goto ready3;
	DualWieldSelect:
		TNT1 A 0 {
			A_PlaySoundEx("Ironsights", "Auto");
	...
	DualFireReload:
		...
		TNT1 A 0 {
			If (CountInv("QSSGAmmoCounter") != 4 && CountInv("NewShell") > 0) {
				...
				return ResolveState("ReloadAkimboRight");
				}
			Else If (CountInv("LeftQSSGAmmoCounter") != 4 && CountInv("NewShell") > 0) {
				A_ClearOverlays(10, 14);
				return ResolveState("ReloadAkimboOnlyLeftBegin");
				}
			return ResolveState(null);
			}
		Goto Ready3;
	...
	InsertShellsAnimationRight:
		...
		"####" A 0 {
			if (CountInv("QSSGAmmoCounter") == 3 || CountInv("NewShell") == 1) {
					return ResolveState("InsertOneByOneRight");
				}
			return ResolveState(null);
			}
		QRS2 A 0 A_JumpIfInventory("QSSGAmmoCounter", 2, 3);
		...
		"####" A 0 {
			if (CountInv("QSSGAmmoCounter") == 3 && CountInv("NewShell") >= 1) {
				...
				return ResolveState("InsertShellsAnimationRight");
			}	
			else if (CountInv("QSSGAmmoCounter") != 4 && CountInv("NewShell") >= 1) {
					return ResolveState("InsertOneByOneRight");
				}
			else {
				return ResolveState("FinishReloadRight");
			}
			return ResolveState(null);
		}
		Loop;
	...
	InsertOneByOneInsertRight:
		...
		"####" A 0 {
			if (CountInv("QSSGAmmoCounter") == 4 || CountInv("NewShell") == 0) {
				return ResolveState("FinishReloadFromOneByOneRight");
			}
			return ResolveState(null);
		}
		"####" HFE 1;
	...
	FinishReloadRight:	
		...
		TNT1 A 0 {
			if (CountInv("LeftQSSGAmmoCounter") != 4 && CountInv("NewShell") >= 1) {
				A_ClearOverlays(10, 14);
				return ResolveState("ReloadAkimboOnlyLeft");
				}
			return ResolveState(null);
			}
		QAKS RQPON 1;
	...
	InsertShellsAnimationLeft:
		...
		"####" A 0 {
			if (CountInv("LeftQSSGAmmoCounter") == 3 || CountInv("NewShell") == 1) {
					return ResolveState("InsertOneByOneLeft");
				}
			return ResolveState(null);
			}
		QRS2 A 0 A_JumpIfInventory("LeftQSSGAmmoCounter", 2, 3);
		...
		"####" A 0 {
			if (CountInv("LeftQSSGAmmoCounter") == 3 && CountInv("NewShell") >= 1) {
				...
				return ResolveState("InsertShellsAnimationLeft");
			}	
			else if (CountInv("LeftQSSGAmmoCounter") != 4 && CountInv("NewShell") >= 1) {
					return ResolveState("InsertOneByOneLeft");
				}
			else {
				return ResolveState("FinishReloadLeft");
			}
			return ResolveState(null);
		}
		Loop;
	...
	InsertOneByOneInsertLeft:
		...
		"####" A 0 {
			if (CountInv("LeftQSSGAmmoCounter") == 4 || CountInv("NewShell") == 0) {
				return ResolveState("FinishReloadFromOneByOneLeft");
			}
			return ResolveState(null);
		}
		"####" HFE 1;
	...
	InsertShellsAnimation:
		...
		"####" A 0 {
			if (CountInv("QSSGAmmoCounter") == 3 || CountInv("NewShell") == 1) {
					return ResolveState("InsertOneByOne");
				}
			return ResolveState(null);
			}
		QRS2 A 0 A_JumpIfInventory("QSSGAmmoCounter", 2, 3);
		...
		"####" A 0 {
			if (CountInv("QSSGAmmoCounter") == 3 && CountInv("NewShell") >= 1) {
				...
				return ResolveState("InsertShellsAnimation");
			}	
			else if (CountInv("QSSGAmmoCounter") != 4 && CountInv("NewShell") >= 1) {
					return ResolveState("InsertOneByOne");
				}
			else {
				return ResolveState("FinishReload");
			}
			return ResolveState(null);
		}
		Loop;
	...
	InsertOneByOneInsert:
		...
		"####" A 0 {
			if (CountInv("QSSGAmmoCounter") == 4 || CountInv("NewShell") == 0) {
				return ResolveState("FinishReloadFromOneByOne");
			}
			return ResolveState(null);
		}
		"####" HFE 1;
	...
	UnloadAkimbo:
		TNT1 A 0{
			If (CountInv("LeftQSSGAmmoCounter") > 0 || CountInv("QSSGAmmoCounter") > 0) {
					A_ClearOverlays(10, 14);
					return ResolveState("UnloadAkimboReal");
				}
			return ResolveState(null);
		}
		Goto Ready3;
	...
	UnloadAkimboReal:
		...
		TNT1 A 0 {
			If (CountInv("QSSGAmmoCounter") > 0) {
					return ResolveState("UnloadAkimboRight");
				}
			else if (CountInv("LeftQSSGAmmoCounter") > 0) {
					return ResolveState("UnloadAkimboLeft");
			}
			else {
				return ResolveState(null);
			}
	...
	UnloadAkimboRight:
		...
		"####" A 0 {
			if (CountInv("QSSGAmmoCounter") == 1) {
					return ResolveState("TakeOneByOneAkimboRight");
				}
			return ResolveState(null);
			}
	UnloadAnimationAkimboRight:
        ...
        "####" A 0 A_PlaySound("QSGIN", 2);
		"####" NMLKJIII 1;
		"####" A 0 PB_UnloadMag("QSSGAmmoCounter","NewShell",2,0,1,0,"PB_SingleShell");
		"####" A 0 {
			 if (CountInv("QSSGAmmoCounter") >= 2) {
				return ResolveState("UnloadAnimationAkimboRight");
			}	
			else if (CountInv("QSSGAmmoCounter") == 1) {
					return ResolveState("TakeOneByOneAkimboRight");
				}
			else {
				return ResolveState("FinishUnloadAkimboRight");
			}
			return ResolveState(null);
		}
		Loop;
	...
	UnloadAkimboLeft:
		...
		"####" A 0 {
			if (CountInv("LeftQSSGAmmoCounter") == 1) {
					return ResolveState("TakeOneByOneAkimboLeft");
				}
			return ResolveState(null);
			}
	UnloadAnimationAkimboLeft:
        ...
        "####" A 0 A_PlaySound("QSGIN", 2);
		"####" NMLKJIII 1;
		"####" A 0 PB_UnloadMag("LeftQSSGAmmoCounter","NewShell",2,0,1,0,"PB_SingleShell");
		"####" A 0 {
			 if (CountInv("LeftQSSGAmmoCounter") >= 2) {
				return ResolveState("UnloadAnimationAkimboLeft");
			}	
			else if (CountInv("LeftQSSGAmmoCounter") == 1) {
					return ResolveState("TakeOneByOneAkimboLeft");
				}
			else {
				return ResolveState("FinishUnloadAkimboLeft");
			}
			return ResolveState(null);
		}
		Loop;
	...
	Unload:
		...
		"####" A 0 {
			if (CountInv("QSSGAmmoCounter") == 1) {
					return ResolveState("TakeOneByOne");
				}
			return ResolveState(null);
			}
	UnloadAnimation:
		...
		"####" A 0 {
			 if (CountInv("QSSGAmmoCounter") >= 2) {
				return ResolveState("UnloadAnimation");
			}	
			else if (CountInv("QSSGAmmoCounter") == 1) {
					return ResolveState("TakeOneByOne");
				}
