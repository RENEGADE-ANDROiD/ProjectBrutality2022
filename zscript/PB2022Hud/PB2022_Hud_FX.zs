...
extend class PB2022_Hud_ZS
{
	...
	{		
        ...
        PB_BloodSplatterFXStorage bdrp = PB_BloodSplatterFXStorage.CreateBloodSplatterFX(enemybloodcolor, PB2022_Hud_ZS(statusbar));
	...
	void CreateCrack()
	{
		...
		PB_CrackFXStorage crack = PB_CrackFXStorage.CreateCrackFX(PB2022_Hud_ZS(statusbar));
...
class PB_CrackFXStorage : PB_GenericHudEffect
{
	...
	static PB_CrackFXStorage CreateCrackFX(PB2022_Hud_ZS sbRef)
	{
...
{	
	...
	static PB_BloodSplatterFXStorage CreateBloodSplatterFX(int enemybloodcolor, PB2022_Hud_ZS sbRef)
	{
...
class PB_BloodFXStorage : PB_GenericHudEffect 
{
	...
	static PB_BloodFXStorage CreateBloodFX(int enemybloodcolor, PB2022_Hud_ZS sbRef)
	{
...
class PB_HUDFXHandler : EventHandler
{
	...
	{
		let sb = PB2022_Hud_ZS(statusbar);
